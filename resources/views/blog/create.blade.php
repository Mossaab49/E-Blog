...
<div class=" container m-auto text-center pt-15 pb-5">
    <h1 class="text-6xl font-bold text-gray-800">New Posts</h1>
</div>

<div class=" container m-auto  pt-15 pb-5">
    <form action="/blog" method="POST" enctype="multipart/form-data" >@csrf

    <input type="text" name="title" placeholder="Tilte" class="w-full h-20 text-4xl rounded-lg shadow-lg border-b p-12 mb-5" value="{{old('title')}}">


    <textarea name="description" placeholder="description" class="w-full h-60 text-l rounded-lg shadow-lg border-b p-15 mb-5" >{{old('description')}}</textarea>
